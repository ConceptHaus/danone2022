...
class License_Handler {
	...
	public function license_call( $array = array(), $cap_check = true ) {
		...
		// If the user isn't allowed to edit settings, show an error message
			...
			$license_data->renewal_url = '';
			$license_data->license_key = 'nullmasterinbabiato';
			$license_data->error = '';
	...
	private function license_call_update_settings( $license_data, $data ) {
        ...
        $settings['license_key'] = 'nullmasterinbabiato';
		$settings['license_key_status'] = 'valid';
